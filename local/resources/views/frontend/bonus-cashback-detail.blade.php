                 ...
                 <div class="col-lg-12">
                     <nav aria-label="breadcrumb">
                         <ol class="breadcrumb">
                             ...
                             <li class="breadcrumb-item active text-truncate" aria-current="page"> Bonus Cashback Detail
                             </li>
                         </ol>
                     </nav>
                 </div>
                 ...
                 <div class="col-md-12">
                             ...
                             <div class="row g-3">
                                 ...
                                 <div class="col-md-6 col-lg-2">
                                     ...
                                     <select class="form-select" id="month" aria-label="Default select example">
                                         <option value="01" @if (date('m') == '01') selected @endif>January
                                         </option>
                                         <option value="02" @if (date('m') == '02') selected @endif>February
                                         </option>
                                         <option value="03" @if (date('m') == '03') selected @endif>March
                                         </option>
                                         <option value="04" @if (date('m') == '04') selected @endif>April
                                         </option>
                                         <option value="05" @if (date('m') == '05') selected @endif>May
                                         </option>
                                         <option value="06" @if (date('m') == '06') selected @endif>June
                                         </option>
                                         <option value="07" @if (date('m') == '07') selected @endif>July
                                         </option>
                                         <option value="08" @if (date('m') == '08') selected @endif>August
                                         </option>
                                         <option value="09" @if (date('m') == '09') selected @endif>September
                                         </option>
                     ...
                     <div class="card card-box borderR10 mb-2 mb-md-0">
                         <div class="card-body">
                             <div class="row">
                                 <div class="col-sm-6">
                                     <h4 class="card-title mb-0">Bonus CashBack</h4>
                                 </div>
 ...
 <script>
     $(function() {
         table_order = $('#cashback').DataTable({
             ...
             ajax: {
                 url: '{{ route('datatable_casback_detail') }}',
                 data: function(d) {
             ...
             columns: [
                 ...
                 {
                     "data": "route",
                     "title": "Bonus Run Round",
                     "className": "w-1"
                 },
                 {
                     "data": "bonus_total_usd",
                     "title": "Amount Received in USD",
                     "className": "w-1"
                 },
                 {
                     "data": "note",
