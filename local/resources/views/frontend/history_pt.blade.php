                 ...
                 <div class="col-lg-12">
                     <nav aria-label="breadcrumb">
                         <ol class="breadcrumb">
                             ...
                             <li class="breadcrumb-item active text-truncate" aria-current="page"> History PT</li>
                         </ol>
                     </nav>
                 </div>
             </div>
                 ...
                 <div class="col-md-12">
                     ...
                     <div class="card card-box borderR10 mb-2 mb-md-0">
                         <div class="card-body">
                             <div class="row">
                                 <div class="col-sm-6">
                                     <h4 class="card-title mb-0">History PT</h4>
                                 </div>
 ...
 <script>
     $(function() {
         table_order = $('#cashback').DataTable({
             ...
             ajax: {
                 url: '{{ route('datatable_pv_per_month') }}',
                 data: function(d) {
