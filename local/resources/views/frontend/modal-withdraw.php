  ...
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
    <div class="modal-content borderR25">
      ...
      <div class="modal-footer justify-content-between border-0">
        ...
        <button type="button" class="btn btn-p1 rounded-pill d-flex align-items-center" data-bs-target="#withdrawModal2" data-bs-toggle="modal"><i class='bx bxs-check-circle me-2'></i>ทำรายการ</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
    <div class="modal-content borderR25">
      ...
      <div class="modal-footer justify-content-between border-0">
        ...
        <button type="button" class="btn btn-p1 rounded-pill d-flex align-items-center" data-bs-target="#withdrawModal3" data-bs-toggle="modal"><i class='bx bxs-check-circle me-2'></i>ยืนยันทำรายการ</button>
      </div>
    </div>
  </div>
</div>
