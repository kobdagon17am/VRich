        ...
        <div class="statbox widget box box-shadow mb-4 mt-4">
            ...
            <div class="row mb-4 ml-2">
                <div class="col-lg-2 mt-2">
                    ...
                    <input type="date" class="form-control  myCustom date_start" name="date_start" placeholder="วันที่เริ่มต้น">
                </div>

                <div class="col-lg-2 mt-2">
                    <label>วันที่สิ้นสุด</label>
                    <input type="date" class="form-control  myCustom date_end" name="date_end" placeholder="วันที่สิ้นสุด">
                </div>
