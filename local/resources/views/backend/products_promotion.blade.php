                                    ...
                                    <div class="card multiple-form-one px-0 pb-0 mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mx-0">
                                                <form method="POST" action="{{ route('admin/Products_insert_promotion') }}"
                                                            ...
                                                            <div class="w-100">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-6 mt-2">
                                                                      ...
                                                                      <div class="col-lg-6  mt-2">
                                                                            <label><b>จำนวนชิ้นที่ขายต่อแพค:</b></label>
                                                                            <input type="number" class="form-control"
                                                                                 name="pack_qty"
                                                                                placeholder="จำนวนชิ้นที่ขายต่อแพค">
                                                                        </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="card multiple-form-one px-0 pb-0 mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mx-0">
                                                    <form method="POST"
                                                        action="{{ route('admin/edit_products_promotion') }}"
                                                        enctype="multipart/form-data" id="msform">
                                                        @csrf
                                                        <ul id="progressbar">
                                                            <li class="active" id="account" style="width: 50%;">
                                                                ...
                                                                <div class="w-100">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-lg-3  mt-2">
                                                                            <label><b>ราคาต้นทุน (Bat):</b></label>
                                                                            <input type="number" step="any"
                                                                                class="form-control" id="product_cost_th"
                                                                                name="product_cost_th"
                                                                                placeholder="ราคาต้นทุน (บาท)">
                                                                        </div>
                                                                        ...
                                                                        <div class="col-lg-3  mt-2">
                                                                            <label><b>ราคาต้นทุน (USD):</b></label>
                                                                            <input type="number" step="any"
                                                                                class="form-control" id="product_cost_usd"
...
@section('js')
    ...
    <script>
        function edit(id) {
            $.ajax({
                    url: '{{ route('admin/view_products_promotion') }}',
                    type: 'GET',
                    data: {
                        id
                    }
                ...
                .done(function(data) {
                    ...
                    $("#edit").modal();
                    $("#id").val(data['data']['id']);
                    $("#pack_qty").val(data['data']['pack_qty']);
