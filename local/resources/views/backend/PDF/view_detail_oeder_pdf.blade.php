    ...
    <div class="row box_detail ">
        ...
        <div class="row text-total text-content">
            ...
            <div class="col-2 mr-2  text-right  ">
                <p> {{ number_format($item->sum_price) }} USD</p>
                <p>{{ number_format($item->pv_total) }} PT</p>
                <p>{{ number_format($item->shipping_price) }} USD</p>
                {{-- <p>{{ $item->shipping_type }}</p> --}}

                {{-- <p>{{ number_format($item->discount) }} USD</p> --}}
                <p>{{ number_format($item->ewallet_price) }} USD</p>
            </div>
        </div>
